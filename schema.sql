...
-- Per-reader repeat visits to each chapter, used to build a personal reading shelf.
...
-- Public reader bookmarks. The owner relationship stays server-side; public
-- responses never expose user_id. Paid passages are deliberately excerpt-limited.
...
-- Gifts (tips during live streams + notes-page support)
