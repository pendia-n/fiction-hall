  ...
  return (
    <div className="editorial-page info-page legal-page card">
      <div className="terms-content">
        ...
        <h3>Personal Data from Services:</h3>
        ...
        <h2>3. Retention</h2>
        <p>We retain Personal Data only as needed to provide Services, resolve disputes, ensure safety/security, or comply with legal obligations. Retention depends on:</p>
        <ul>
          <li>Purpose (e.g., service delivery).</li>
          <li>Data amount, nature, and sensitivity.</li>
          <li>Risk of harm from unauthorized use/disclosure.</li>
